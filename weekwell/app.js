  ...
  function viewProfile() {
    ...
    return `
      <div class="card">
        ...
        <div class="row mt"><button class="mini" data-tab="settings">✏️ ${t('edit_profile')}</button><button class="mini primary" data-storybtn="1">➕ ${t('add_story')}</button>${m.story ? `<span class="pill acc">${t('story_active')}</span>` : ''}<input type="file" accept="image/*" data-storyfile hidden></div>
      </div>
