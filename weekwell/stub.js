...
(function () {
  ...
  function seed() {
    ...
    return { me: 'u1', lang: 'sk', consent: true, group: { id: 'g1', name: 'Chalani & Zuza', emoji: '🚴', admin: 'u1', slots: 3, tz: 'Europe/Bratislava', members, paused: ['u4'] }, lib, cur, next, logs, events, goals, results, catchup: { available: true, active: false, from_week: iso(new Date(ws.getTime() - 7 * 864e5)) }, profile: { checkinTime: '20:30', notif: { checkin: true, reminder: true, social: true, proposals: true }, avatar_url: null, location: 'Bratislava', bio: 'Beh, bicykel, sauna.', stats: { height_cm: 183, weight_kg: 86.5, birth_year: 1980, resting_hr: 56 }, share: { weight_kg: false, height_cm: true, resting_hr: true } }, photos: [] };
  }
